...
\title{InterventionViz: A Visual Analysis of Behaviour Changing Event Dynamics}
...
\section{Design}
info here on vis design choices and what we are looking for in the data.

Existing “macro-scale” analyses methods can determine if an intervention has a significant influence over our target behavior, but it does not give much insight into how the event has an effect over time. 
...
Ideally this graph will show some smooth bump showing the delay before the effect kicks in and the falloff as it ends.
