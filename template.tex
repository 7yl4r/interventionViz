...
\item
 D. Spruijt-Metz is with the University of Southern California Center for Economic and Social Research.
\item
 E. Hekler is with Arizona State University.
\item
 D. Rivera is with the ASU Control Systems Engineering Laboratory.
\item
...
Just-in-time adaptive interventions (JITAIs) designed to optimize a subjects behavior based on their momentary context are under exploration as a potentially powerful ally for practitioners and commercial behavior health applications.
...
In this work we explore the application of aggregated time-series visualization and system identification techniques to aid analysis of intervention event effects with emphasis on the dynamics of participant response to intervention.
...
The insights presented in this work offer a foundation for future research addressing this problem and as a guide for behavioral engineers.
} % end abstract
...
%% Uncomment below to include a teaser figure.
  \teaser{
   ...
   \caption{
    ...
    C) Heart rate data aggregated across KNOWME participants shows a mild response to an SMS intervention.
