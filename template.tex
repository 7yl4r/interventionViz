...
Existing work on the analysis of systems usability \cite{harrison1994} may need to be applied to the evaluation of JiTAI systems, however, this work focuses largely on a single record, rather than generalizations drawn from across many.
