...
%% Uncomment below to include a teaser figure.
   ...
   TODO: color by events and make shorter 
   ...
   TODO: reference B,C,D from text
   }
  }
...
Behavior change interventions are particularly important to modern health care systems in developed countries, where preventative behavioral treatment recieves little attention from heath care practitioners.
...
This work breaks new ground in the appliation domain, but also provides guidelines for future work bridging the data visualization and behavioral science communities.
...
Recent advances in sensing and ubiquitous computing are enabling examination of behavior at much smaller time scales (on the order of seconds) and in a wide range of daily life contexts.

New wearable sensing technologies are changing the way we...

\subsubsection{Related Event-based Time Series Visualization}
Existing research in event sequence analysis /cite{Wongsuphasawat2011}, including analysis of event paterns /cite{Wongsuphasawat2012, fails2006, vrotsou2007} and the relation of multiple sympotms /cite{wongsuphasawat2011outflow} helps researchers examine outcomes on a "macro-scale". 
Additionaly, methods for exploring the flow of individuals between many event types and statistical analysis to highlight relationships between events has been established /cite{gotz2014}.
...
TODO: How is the problem here similar to what has come before?  How is it different?  

TODO: mention the SBM study data here!
